        ...
        <div className = "package-home">
            ...
            <div className = "cards-list">
                ...
                <div className = "cards">
                    ...
                    <div className = "learn-more">
                    {/* <button type="button" class="btn btn-secondary"></button> */}
                    <a class="btn btn-secondary" href="https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-apache-maven-registry" role="button">Learn more</a>
                    </div>
                </div>
                <div className = "cards">
                    <div className = "card-title">
                        <div className = "item-logo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 28 28" fill="none" class="mr-1 mt-1"><path d="M20.445 4.766h-7.334a7.587 7.587 0 00-7.62 7.598V19.7a7.588 7.588 0 007.587 7.587h7.335A7.587 7.587 0 0028 19.689v-7.324a7.587 7.587 0 00-7.555-7.598zm-7.411 8.202a2.196 2.196 0 11-3.136-3.077 2.196 2.196 0 013.136 3.077zm7.28 10.64a3.843 3.843 0 110-7.686 3.843 3.843 0 010 7.686z" fill="#004880"></path><path d="M3.02 5.215a2.196 2.196 0 100-4.392 2.196 2.196 0 000 4.392z" fill="#fff" stroke="#004880"></path><path d="M3.02 6.04a3.02 3.02 0 100-6.04 3.02 3.02 0 000 6.04z" fill="#004880"></path></svg>
                    ...
                    <div className = "learn-more">
                    {/* <button type="button" class="btn btn-secondary"></button> */}
                    <a class="btn btn-secondary" href="https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-nuget-registry" role="button">Learn more</a>
                    </div>
                </div>
                <div className = "cards">
                    <div className = "card-title">
                        <div className = "item-logo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 28 28" fill="none" class="mr-1 mt-1"><g clip-path="url(#clip0)" fill="#D6422B"><path d="M9.072 9.308l-.016-.015-3.504 3.453 8.508 8.37 3.504-3.439 5.003-4.93-3.504-3.454v-.016H9.056l.016.031z"></path><path d="M14.028.084l-12.39 7v14l12.39 7 12.39-7v-14l-12.39-7zM24.05 19.746L14.028 25.44 4.006 19.746V8.391l10.022-5.694L24.05 8.391v11.355z"></path></g><defs><clipPath id="clip0"><path fill="#fff" d="M0 0h28v28H0z"></path></clipPath></defs></svg>
                    ...
                    <div className = "learn-more">
                    {/* <button type="button" class="btn btn-secondary"></button> */}
                    <a class="btn btn-secondary" href="https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-rubygems-registry" role="button">Learn more</a>
                    </div>
                </div>
                <div className = "cards">
                    <div className = "card-title">
                        <div className = "item-logo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 28 28" fill="none" data-package-type="NPM" class="mr-1 mt-1">
...
<path d="M5.96399 22.3652H14.0463L14.0565 10.2624H18.0874L18.0771 22.3755H22.1182L22.1285 6.2315L5.98455 6.21094L5.96399 22.3652Z" fill="white"></path>
                ...
                <div className = "cards">
                    ...
                    <div className = "learn-more">
                    <a class="btn btn-secondary" href="https://docs.github.com/en/packages/learn-github-packages/introduction-to-github-packages" role="button">Learn more</a>
                    </div>
                </div>
